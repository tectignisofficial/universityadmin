                        ...
                        <div class="breadcrumbs-inner">
                            <div class="container">
                                <div class="breadcrumbs-text">
                                    <h1 class="breadcrumbs-title">Master in Digital Marketing</h1>
                                    <div class="back-nav">
                                        <ul>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <h4 style="font-size: 23px; font-weight: 800;">Digital Marketing</h4>
                                <div class="image-banner"><img src="assets\images\course-single\digital-marketing.webp" alt="user"></div>
                                <div class="course-single-tab">
                                    ...
                                    <div class="tab-content" id="back-tab-content">
                                        <div class="tab-pane fade show active" id="discription" role="tabpanel" aria-labelledby="discription">
                                            ...
                                            <p>Digital marketing is all about advertising and promotionof brands, products, and services through the use of digital media. Digital marketing is considered to be one of the most effective and economical as compared to all other Media.Importance of this medium of advertising is growing day by day and this has guided many people to take up digital marketing as their career option.</p>
                                            <p>Once you have acquired digital advertising skills you can even start your own business, and create marketing plans for businesses and individuals.</p>
                                            <div class="back-tag"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-tag"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg> <a href="#">All you need to join the course:</a>
                                            <ul>
                                                <li><i class="icon_check"></i>Graduate or Under Graduate in any stream</li>
                                                <li><i class="icon_check"></i>Sales and Marketing professionals</li>
                                                <li><i class="icon_check"></i>Entrepreneurs</li>
                                            </ul>
                                    </div>
                                            <ul class="back-objectives">
                                                <li><h3>Learning Objectives</h3></li>
                                                <li><i class="icon_check"></i> Website Fundamentals</li>
                                                <li><i class="icon_check"></i> How to Make Website/Blog</li>
                                                <li><i class="icon_check"></i> SEO Research & Analysis</li>
                                                <li><i class="icon_check"></i> On-page Optimization</li>
                                                <li><i class="icon_check"></i> Off-page Optimization</li>
                                                <li><i class="icon_check"></i> Social Media Marketing</li>
                                            </ul>
                                        ...
                                        <div class="tab-pane fade" id="curriculum" role="tabpanel" aria-labelledby="curriculum">
                                            ...
                                            <p>The Digital Marketing course curriculum covers a wide range of topics that are essential for anyone looking to pursue a career in marketing.</p>
