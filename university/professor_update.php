...
$sql=mysqli_query($conn,"UPDATE `proffessor` SET `firstName`='$fName',`lastName`='$lname',
`email`='$email',`course`='$course',`gender`='$gender',`DOB`='$DOB',`file`='$file',`username`='$username',
`password`='$password', `mobileNo`='$mobileNo',`message`='$message' WHERE id ='$sid'");
        ...
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <?php
                               $sql=mysqli_query($conn,"select * from proffessor where id='$sid'");
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input data-provide="datepicker" data-date-autoclose="true"  value="<?php echo $row['DOB'] ?>" name="DOB" class="form-control" placeholder="Date of Birth">
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-12">
                                                <label>Gender</label>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group mt-3">
                                                    ...
                                                    <textarea rows="4" name="message" class="form-control no-resize" placeholder="Please type what you want..."><?php echo $row['message'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
