                        ...
                        <div class="breadcrumbs-inner">
                            <div class="container">
                                <div class="breadcrumbs-text">
                                    <h1 class="breadcrumbs-title">Master Course</h1>
                                    <div class="back-nav">
                                        <ul>
                        ...
                        <div class="col-lg-4 offset-2">
                            <div class="course__item mb-30">
                                ...
                                <div class="course__inner">
                                    ...
                                    <h3 class="back-course-title"><a href="master-in-web-devlopment.php">Master in Web Devlopment</a></h3>
                        ...
                        <div class="col-lg-4">
                            <div class="course__item mb-30">
                                ...
                                <div class="course__inner">
                                    ...
                                    <h3 class="back-course-title"><a href="coureses-single.html">Master in Digital Marketing</a></h3>
                                    <div class="course__card-icon d-flex align-items-center">
                                        <div class="course__card-icon--1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="feature__item mb-30 transition-3 white-bg">
                                    ...
                                    <div class="feature__content">
                                        <h3 class="feature__title-1"><a href="contact.html">HTML</a></h3>
