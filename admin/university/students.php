                     ...
                     $count=1;
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" class="btn btn-icon btn-sm" href="students_update.php?sid=<?php echo $arr['id'] ?>" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="students.php?delid=<?php echo $arr['id'] ?>" class="btn btn-icon btn-sm" title="Delete"><i class="fa fa-trash-o text-danger"></i></a>
                                        </td>
                                    </tr>
                                    <?php $count++;   } ?>
                                </tbody>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input data-provide="datepicker" data-date-autoclose="true" name="regDate" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
