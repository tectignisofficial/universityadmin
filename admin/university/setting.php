...
if(isset($_POST['instaMojoSubmit'])){
    ...
    if(isset($_POST['companysubmit'])){
        ...
        $sql=mysqli_query($conn,"UPDATE `company` SET `companyname`='$companyname',`mobileNumber`='$mobileNumber',`address`='$address',`companyEmail`='$companyEmail',`websiteurl`='$websiteurl',`facebook`='$facebook',`instagram`='$instagram',`twitter`='$twitter',`linkedin`='$linkedin' WHERE id='1'");
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="companyname" type="text" value="<?php echo $row['companyname']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="mobileNumber"value="<?php echo $row['mobileNumber']?>" type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <textarea class="form-control" name="address" placeholder="44 Shirley Ave. West Chicago, IL 60185" aria-label="With textarea"value="<?php echo $row['address']?>"><?php echo $row['address']?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $row['companyEmail']?>" name="companyEmail">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="websiteurl"value="<?php echo $row['websiteurl']?>"class="form-control" placeholder="http://">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="facebook"value="<?php echo $row['facebook']?>" class="form-control" placeholder="http://">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Instagram</label>
                                                <input type="text" value="<?php echo $row['instagram']?>" name="instagram" class="form-control" placeholder="http://">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Twitter</label>
                                                <input type="text" value="<?php echo $row['twitter']?>" name="twitter" class="form-control" placeholder="http://">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>LinkedIn</label>
                                                <input type="text" value="<?php echo $row['linkedin']?>" name="linkedin" class="form-control" placeholder="http://">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 text-right m-t-20">
                                            <button type="submit" name="companysubmit" class="btn btn-primary">SAVE</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"name="fromemail" value="<?php echo $row1['fromemail'] ?>"type="email">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Emails From Name</label>
                                                <input class="form-control" value="<?php echo $row1['emailname'] ?>"name="emailname"type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>SMTP HOST</label>
                                                <input class="form-control" value="<?php echo $row1['smtpHost'] ?>"name="smtpHost"type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>SMTP USER</label>
                                                <input class="form-control" value="<?php echo $row1['smtpuser'] ?>"name="smtpuser"type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>SMTP PASSWORD</label>
                                                <input class="form-control" value="<?php echo $row1['smtpPassword'] ?>"name="smtpPassword"type="password">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>SMTP PORT</label>
                                                <input class="form-control" value="<?php echo $row1['smtpPort'] ?>"name="smtpPort"type="text">
                                            </div>
                                        </div>
                                        <!-- <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12 m-t-20 text-right">
                                            <button type="submit" name="emailconfig" class="btn btn-primary">SAVE</button>
                                        </div>
                                    </div>                            
                                </form>
                            </div>
